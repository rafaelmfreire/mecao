...
<main>
	<div class="bg-white container mx-auto rounded-xl lg:rounded-[24px] p-4 lg:p-8 my-6 grid grid-cols-12 gap-4 lg:gap-8">
		<div class="col-span-12 space-y-4 lg:space-y-0 xl:col-span-8">
			...
			?>
					<a class="block group mb-10" href="<?php the_permalink(); ?>">
						<article>
							<div class="rounded-md relative  overflow-hidden shadow">
								...
								<header class="p-4 lg:p-6 absolute bottom-0">
									<h2 class="group-hover:underline text-pretty text-base leading-6 md:text-[2.5rem] md:leading-[2.875rem] font-medium md:font-bold text-white [text-shadow:_2px_2px_2px_rgb(0_0_0_/_50%)]"><?php the_title(); ?></h2>
								</header>
							</div>
						</article>
					</a>
