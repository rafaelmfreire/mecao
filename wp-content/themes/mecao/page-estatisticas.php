...
$rankingJogos = json_decode(
    '{"jogos": ' .
        ...
        '{"nome":"Alan",            "j":6},' .
        '{"nome":"Souza",           "j":6},' .
        '{"nome":"Marcos Ytalo",    "j":6},' .
        '{"nome":"Gustavo Henrique","j":6}' .
        ']}'
);
$rankingGols = json_decode(
    '{"gols": ' .
        '[' .
        '{"nome":"Gustavo Henrique","j":6,"g":2},' .
        '{"nome":"Alan",            "j":6,"g":2},' .
        '{"nome":"Matheuzinho",     "j":2,"g":1},' .
        '{"nome":"Caio Hones",      "j":4,"g":1},' .
        '{"nome":"Giovani",         "j":5,"g":1},' .
        '{"nome":"Norberto",        "j":5,"g":1},' .
        '{"nome":"Marcos Ytalo",    "j":6,"g":1},' .
        '{"nome":"Souza",           "j":6,"g":1}' .
        ']}'
);
$rankingAssistencias = json_decode(
    '{"assistencias": ' .
        '[' .
        '{"nome":"Guilherme Guedes","j":6,"a":2},' .
        '{"nome":"Souza",           "j":6,"a":2},' .
        '{"nome":"Rafinha",         "j":2,"a":1},' .
        '{"nome":"Cauã Paixão",     "j":4,"a":1},' .
        '{"nome":"Antônio Villa",   "j":5,"a":1},' .
        '{"nome":"Henrique",        "j":7,"a":1}' .
        ']}'
);
$rankingMinutagem = json_decode(
    '{"minutagem": ' .
        '[' .
        '{"nome":"Renan Bragança","j":8,"m":786},' .
        '{"nome":"Salazar",           "j":7,"m":688},' .
        '{"nome":"Ferreira",         "j":7,"m":653},' .
        '{"nome":"Alan",     "j":6,"m":588},' .
        '{"nome":"Wenderson",   "j":7,"m":552},' .
        '{"nome":"Souza",        "j":6,"m":542},' .
        '{"nome":"Marcos Ytalo",        "j":6,"m":541},' .
        '{"nome":"Gustavo Henrique",        "j":6,"m":508},' .
        '{"nome":"Gabriel Davis",        "j":7,"m":426},' .
        '{"nome":"Marquinhos Pedroso",        "j":5,"m":386}' .
        ']}'
);
$rankingAmarelos = json_decode(
    '{"amarelo": ' .
        ...
        '{"nome":"Marcos Ytalo",    "j":6,"a":2},' .
        '{"nome":"Gustavo Henrique","j":6,"a":2},' .
        '{"nome":"Antônio Villa",   "j":5,"a":2},' .
        '{"nome":"Rodriguinho",   "j":2,"a":1},' .
        '{"nome":"Cauã Paixão","j":4,"a":1},' .
        '{"nome":"Giovani",        "j":5,"a":1}' .
        ']}'
);
