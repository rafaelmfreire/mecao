...
$rankingJogos = json_decode(
    '{"jogos": ' .
        '[' .
        '{"nome":"Renan Bragança",  "j":7},' .
        '{"nome":"Souza",           "j":7},' .
        '{"nome":"Alan",            "j":7},' .
        '{"nome":"Ferreira",         "j":7},' .
        '{"nome":"Giovani",        "j":7},' .
        '{"nome":"Rafael Jansen",            "j":6},' .
        '{"nome":"Norberto",   "j":6},' .
        '{"nome":"Gustavo Ramos",    "j":6},' .
        '{"nome":"Rodriguinho",         "j":6},' .
        '{"nome":"Juliano",     "j":6}' .
        ']}'
);
$rankingGols = json_decode(
    '{"gols": ' .
        '[' .
        '{"nome":"Gustavo Ramos",         "j":6,"g":2},' .
        '{"nome":"Souza",           "j":7,"g":2},' .
        '{"nome":"Marcos Ytalo","j":4,"g":1},' .
        '{"nome":"Rafinha",         "j":5,"g":1},' .
        '{"nome":"Matheuzinho",   "j":6,"g":1},' .
        '{"nome":"Ferreira",     "j":7,"g":1},' .
        '{"nome":"Alan",         "j":7,"g":1}' .
        ']}'
);
$rankingAssistencias = json_decode(
    '{"assistencias": ' .
        '[' .
        '{"nome":"Giovani",           "j":7,"a":2},' .
        '{"nome":"Wenderson",     "j":4,"a":1},' .
        '{"nome":"Rafinha",      "j":5,"a":1},' .
        '{"nome":"Souza",   "j":7,"a":1}' .
        ']}'
);
$rankingMinutagem = json_decode(
    '{"minutagem": ' .
        '[' .
        '{"nome":"Renan Bragança",  "j":7,"m":693},' .
        '{"nome":"Souza",           "j":7,"m":667},' .
        '{"nome":"Alan",        "j":7,"m":623},' .
        '{"nome":"Rafael Jansen",            "j":6,"m":590},' .
        '{"nome":"Ferreira",   "j":7,"m":575},' .
        '{"nome":"Norberto",    "j":6,"m":488},' .
        '{"nome":"Gustavo Ramos",     "j":6,"m":413},' .
        '{"nome":"Rodriguinho","j":6,"m":411},' .
        '{"nome":"João Lucas",        "j":4,"m":354},' .
        '{"nome":"Salazar",         "j":5,"m":349}' .
        ']}'
);
$rankingAmarelos = json_decode(
    '{"amarelo": ' .
        '[' .
        '{"nome":"Rodriguinho",    "j":6,"a":4},' .
        '{"nome":"Marcos Ytalo",      "j":4,"a":3},' .
        '{"nome":"Matheuzinho",   "j":6,"a":3},' .
        '{"nome":"Rafael Jansen",       "j":6,"a":3},' .
        '{"nome":"Gilvan",         "j":3,"a":2},' .
        '{"nome":"Antônio Villa",         "j":4,"a":2},' .
        '{"nome":"Gustavo Ramos",        "j":6,"a":2},' .
        '{"nome":"Alan",  "j":7,"a":2},' .
        '{"nome":"Souza",          "j":7,"a":2},' .
        '{"nome":"Caio Hones",           "j":2,"a":1}' .
        ']}'
);
$rankingVermelhos = json_decode(
    '{"vermelho": ' .
        '[' .
        '{"nome":"Gustavo Henrique","j":3,"v":1},' .
        '{"nome":"Antônio Villa",     "j":4,"v":1}' .
        ']}'
);
...
<div x-show="show == 2" x-transition class="col-span-12 grid grid-cols-12 gap-4 lg:gap-8">
