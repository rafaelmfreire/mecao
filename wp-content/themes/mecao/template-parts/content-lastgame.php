...
?>
    ...
    <div class="bg-white border border-gray-dark/20 rounded-lg shadow-small mb-8">
        ...
        <header class="flex items-center justify-between bg-gradient-to-r gray-gradient rounded-t-md px-4 py-1">
            ...
            <h2 class="text-gray font-black text-xl lg:text-2xl tracking-tighter italic uppercase">Último Jogo</h2>
        </header>
                ...
                <div class="grid grid-cols-home-matches justify-items-stretch">
                    ...
                    <div class="justify-self-center">
                        ...
                        <div class="flex justify-center">
                            <span class=" text-xs font-medium px-3 py-1 rounded  bg-stone-500 group-hover:bg-stone-700 text-white border border-stone-500/40 shadow-small shadow-stone-500/20 transition-all duration-300 ease-in-out">
                                Veja o pós-jogo
                            </span>
                        </div>
                    </div>
